...
#include "include/Qpairnet_params7_16_65.h"
...
int main(){
    ...
    ////conv1
    start = read_cycles();
    conv1d_matmul_Gemmini(QConv_BN_1_params.batch_size,QConv_BN_1_params.input_width,QConv_BN_1_params.in_channels,gesture_signals,
...
//    block_print1(1,QConv_BN_1_params.output_width, QConv_BN_1_params.out_channels,QConv_BN_1_out);
    ...
    ////conv2
    //start = read_cycles();
    conv1d_matmul_Gemmini(QConv_BN_2_params.batch_size,QConv_BN_2_params.input_width,QConv_BN_2_params.in_channels,QConv_BN_1_out,
...
//    block_print1(1,QConv_BN_2_params.output_width, QConv_BN_2_params.out_channels,QConv_BN_2_out);
    ...
    ////conv3
    //start = read_cycles();
    conv1d_matmul_Gemmini(QConv_BN_3_params.batch_size,QConv_BN_3_params.input_width,QConv_BN_3_params.in_channels,QConv_BN_2_out,
    ...
    ////conv4
    //start = read_cycles();
    conv1d_matmul_Gemmini(QConv_BN_4_params.batch_size,QConv_BN_4_params.input_width,QConv_BN_4_params.in_channels,QConv_BN_3_out,
...
//    block_print1(1,QConv_BN_4_params.output_width, QConv_BN_4_params.out_channels,QConv_BN_4_out);
    ...
    ////conv5
    //start = read_cycles();
    conv1d_matmul_Gemmini(QConv_BN_5_params.batch_size,QConv_BN_5_params.input_width,QConv_BN_5_params.in_channels,QConv_BN_4_out,
...
//    block_print1(QConv_BN_5_params.batch_size,QConv_BN_5_params.output_width, QConv_BN_5_params.out_channels,QConv_BN_5_out);
    ...
    ////Dense
    //start = read_cycles();
    QDense(QConv_BN_5_params.batch_size, QConv_BN_5_params.in_channels, gesN, QGap_out, QDense_params, QDense_bias, QDense_out,downScalar_dense);
    /*printf("\nDense result :\n\n");
    for (int i = 0; i < QConv_BN_5_params.batch_size; ++i) {
	  printf("batch %d\n", i);
