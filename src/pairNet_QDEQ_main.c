...
// gemmini could not do so much double computation
...
int main(){
    ...
    /*****PairNet*****/
    /**conv1**/
    conv1d_matmul_QDEQ(conv1d_1_params.batch_size, conv1d_1_params.input_width,conv1d_1_params.in_channels, gesture_signals,
    ...
    /**conv2**/
    conv1d_matmul_QDEQ(conv1d_2_params.batch_size, conv1d_2_params.input_width,conv1d_2_params.in_channels, conv1d_1_out,
    ...
    /**conv3**/
    conv1d_matmul_QDEQ(conv1d_3_params.batch_size, conv1d_3_params.input_width,conv1d_3_params.in_channels, conv1d_2_out,
    ...
    /**conv4**/
    conv1d_matmul_QDEQ(conv1d_4_params.batch_size, conv1d_4_params.input_width,conv1d_4_params.in_channels, conv1d_3_out,
    ...
    /**conv5**/
    conv1d_matmul_QDEQ(conv1d_5_params.batch_size, conv1d_5_params.input_width,conv1d_5_params.in_channels, conv1d_4_out,
