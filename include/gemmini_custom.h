...
void mc2_1dconv_global_avg(int batch, int out_dim, int out_channels, int PE_N, elem_t * A, elem_t * C)
{
...
/**gemmini conv1d*/
void mc2_conv1d(int dataflow, int act, acc_scale_t scale, elem_t relu_num,  const elem_t * A, const elem_t * B, const acc_t* D, void * C,
